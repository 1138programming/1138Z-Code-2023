...
Shuffleboard shuffleboardClone;
/**
...
void initialize() {
  ...
  //shuffleboardClone.createButtonPlain(100, 50, NULL, LV_ALIGN_IN_TOP_LEFT, 0, 50, 0);
...
void opcontrol() {
  ...
  while (true) {
    shuffleboardClone.clear();
    shuffleboardClone.draw();
    i++;
